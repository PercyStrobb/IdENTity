...
if (pagevisitee=="Documents"){
     ...
     if(nom==0){
        ...
        document.write('<img src="images/templates/nom_prenom1/template_connecté-mesDocs.png" alt="mesdocs2" style="display:block;position:absolute;width:408px;height:664px;top:200px;left:50px;" >');
     }
     if(nom==1){
	        ...
	        document.write('<img src="images/templates/nom_prenom2/template_connecté-mesDocs.png" alt="mesdocs" style="display:block;position:absolute;width:408px;height:664px;top:200px;left:50px;">');    
    
     }
     if(nom==2){
     	        document.write('<img src="images/templates/nom_prenom3/template_connecté-mesImpr.png" alt="template" style="display:block;position:absolute;width:609px;height:498px;left:490px;top:200px;">');
        document.write('<img src="images/templates/nom_prenom3/template_connecté-mesDocs.png" alt="template2" style="display:block;position:absolute;width:408px;height:664px;top:200px;left:50px;">');
     }
 }